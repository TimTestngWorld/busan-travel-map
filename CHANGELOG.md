# Beta 2.12.11｜Launch Root-Cause Fix（2026-09-10）
...
- 2.12.11 將手機 Bottom Sheet 與安裝 App 初始化移回主 async IIFE 內，並在 `buildShell211()` 完成後直接綁定。
...
## Beta 2.12.11｜2026-09-10｜Launch Candidate
