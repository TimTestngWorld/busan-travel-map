/* 釜山旅行地圖 Beta 2.12 Final HF5 — network-first, versioned offline shell */
const VERSION='2.12-final-hf5';
...
self.addEventListener('message',event=>{
  ...
  if(event.data==='GET_VERSION')event.source?.postMessage({type:'PWA_VERSION',version:VERSION,label:'2.12 Final HF5'});
});
